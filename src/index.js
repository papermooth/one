...
(function () {
  // 1. 实例化对象
  var myChart = init(document.querySelector(".pie"));
...
(function () {
  ...
  // 1. 实例化对象
  var myChart = init(document.querySelector(".bar"));
...
(function () {
  ...
  // 1. 实例化对象
  var myChart = init(document.querySelector(".line"));
...
(function () {
  // 1. 实例化对象
  var myChart = init(document.querySelector(".radar"));
...
(function () {
  // 1. 实例化对象
  var myChart = init(document.querySelector(".gauge"));
